...
if (jQuery('#chart-9').length) {
  var chart_9 = new ApexCharts(document.querySelector('#chart-9'), options);
  chart_9.render();
}
...
if (jQuery('#chart-10').length) {
  var chart_10 = new ApexCharts(document.querySelector('#chart-10'), options);
  chart_10.render();
}
if (
  jQuery('#wave-chart-7').length ||
  jQuery('#wave-chart-8').length ||
  jQuery('#wave-chart-9').length ||
  jQuery('#wave-chart-10').length
) {
...
if (jQuery('#am-barline-chart').length) {
  am4core.ready(function () {
    ...
    chart.colors.list = [am4core.color('#089bab'), am4core.color('#FC9F5B')];
...
if (jQuery('#home-pie-chart').length) {
  ...
  var chart = new ApexCharts(
    document.querySelector('#home-pie-chart'),
    options
  );
  chart.render();
}
if (jQuery('#chart-task').length) {
  am4core.ready(function () {
    ...
    series.colors.list = [
      am4core.color('#089bab'),
      am4core.color('#c25a72'),
      am4core.color('#885e72'),
      am4core.color('#726071'),
      am4core.color('#5a6171'),
      am4core.color('#506271'),
    ];
...
if (jQuery('#chart-home3-01').length) {
  ...
  var chart = new ApexCharts(
    document.querySelector('#chart-home3-01'),
    options
  );
  chart.render();
}
...
jQuery('#home-chart-05').length &&
  am4core.ready(function () {
    ...
    var chart = new ApexCharts(
      document.querySelector('#home-chart-05'),
      options
    );
    chart.render();
  });
jQuery('#home-chart-06').length &&
  am4core.ready(function () {
    ...
    var chart = new ApexCharts(
      document.querySelector('#home-chart-06'),
      options
    );
    chart.render();
  });
jQuery('#home-servey-chart').length &&
  am4core.ready(function () {
    var options = {
      series: [
        {
    ...
    var chart = new ApexCharts(
      document.querySelector('#home-servey-chart'),
      options
    );
    chart.render();
  });
jQuery('#patient-chart-1').length &&
  am4core.ready(function () {
    ...
    var chart = new ApexCharts(
      document.querySelector('#patient-chart-1'),
      options
    );
    chart.render();
  });

jQuery('#doc-chart-01').length &&
  am4core.ready(function () {
    am4core.ready(function () {
      // Themes begin
      am4core.useTheme(am4themes_animated);
...
jQuery('.previous').click(function () {
  ...
  jQuery('#top-tab-list li')
    ...
    .removeClass('active');
  jQuery('#top-tab-list li')
    .eq(jQuery('fieldset').index(previous_fs))
    .removeClass('done');
